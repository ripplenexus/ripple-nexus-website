...
import { BottomObserver, RightObserver } from '../utils/Animation';
...
const Footer: React.FC = () => {
    ...
    useEffect(()=>{
        const mediaIcon = document.querySelectorAll('.footer-social-media') as NodeListOf<HTMLElement>;
        mediaIcon.forEach((element, index) => {
            BottomObserver.observe(element);
        });

        const column = document.querySelectorAll('.footer-column') as NodeListOf<HTMLElement>;
    ...
    return (
        ...
        <footer id='footer' className="footer-container">
          {/* <footer className="flex flex-row gap-4.1 pt-4 pb-32 border-t border-footer-border bg-footer-bg text-white">  */}
            <div className="footer-columns">
                <div className="footer-social-media">

                    <svg width="171" height="34.5" viewBox="0 0 114 23" fill="none" xmlns="http://www.w3.org/2000/svg">
